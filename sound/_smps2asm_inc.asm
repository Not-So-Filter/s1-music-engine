...
dHipHopHitKick = $BF
dWoo = $B4
dHipHopHitPowerKick = $C0
dBassHey = $C1
dDanceStyleKick = $C2
dHipHopHitKick3 = $C3
dReverseFadingWind = $C4
dLooseSnareNoise = $C6
dCrashingNoiseWoo = $C8
dQuickHit = $C9
dPowerKickHit = $CB
dLowPowerKickHit = $CC
dLowerPowerKickHit = $CD
dLowestPowerKickHit = $CE
dEchoedClapHit_S3 = $D1
dLowerEchoedClapHit_S3 = $D2
; ---------------------------------------------------------------------------------------------
; Channel IDs for SFX
; ---------------------------------------------------------------------------------------------
cPSG1				= $80
