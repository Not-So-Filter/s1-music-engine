...
Lamp_Blue:	; Routine 2
		...
		bne.s	Lamp_Blue.donothing	; if yes, branch
		tst.b	(f_playerctrl).w
		bmi.s	Lamp_Blue.donothing
		move.b	(v_lastlamp).w,d1
		andi.b	#$7F,d1
		move.b	obSubtype(a0),d2
		andi.b	#$7F,d2
		cmp.b	d2,d1		; is this a "new" lamppost?
		bcs.s	Lamp_Blue.chkhit		; if yes, branch
		lea	(v_objstate).w,a2
		moveq	#0,d0
		move.b	obRespawnNo(a0),d0
		bset	#0,2(a2,d0.w)
...
Lamp_Blue.chkhit:
		...
		bne.s	.fail
		move.b	#id_Lamppost,(a1)	; load twirling	lamp object
